...
simulated_topic = ['/carla/ego_vehicle/imu','/carla/ego_vehicle/lidar']

import csv

imu_path = "imu/imu.csv"
ros_bag = rosbag.Bag('town03_lidar_noise_0.5_imu_noise_clearsunset.bag', 'a')
