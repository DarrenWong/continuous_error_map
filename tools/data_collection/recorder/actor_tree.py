...
class ActorTree(object):
    def __init__(self, world: carla.World, client: carla.Client, actor_config_file=None, base_save_dir=None):
        self.world = world
        self.client = client
        self.actor_config_file = actor_config_file
        self.actor_factory = ActorFactory(self.world, self.client, base_save_dir)
        self.root = Node(None)
        self.node_list = []
